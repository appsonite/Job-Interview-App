...
@implementation TrainingVC_iPhone
...
-(void)viewWillAppear:(BOOL)animated
{
	...
	[UserRecordsManager sharedManager].recordButton = self.recordButton;
}
...
-(IBAction)playPreviousButtonAction{
	...
	if (selectedIndex-1 >=0) {
        ...
        selectedIndex --;
        self.titleLabel.text = [VideosTitles getTitleByIndex:selectedIndex];
        if ((selectedIndex == 9) && (!helper.productPurchased)){
            [self purchaseProduct];
...
-(IBAction)playMentorButtonAction{
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:@"addpoint" object:[NSNumber numberWithInt:selectedIndex+POINT_ADD_VI_MENTOR_1]];
...
-(IBAction)playAnswerButtonAction{
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:@"addpoint" object:[NSNumber numberWithInt:selectedIndex+POINT_ADD_VI_ANSWER_1]];
...
-(IBAction)playButtonAction{
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:@"addpoint" object:[NSNumber numberWithInt:selectedIndex+POINT_ADD_VI_QUESTION_1]];
	//theMovie = [[MPMoviePlayerViewController alloc] init];
	MPMoviePlayerViewController * player=[[MPMoviePlayerViewController alloc]initWithContentURL:MovieURL ];
