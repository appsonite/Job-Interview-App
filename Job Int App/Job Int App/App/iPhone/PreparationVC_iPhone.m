...
@implementation PreparationVC_iPhone
@synthesize theMovie;
...
- (IBAction)go {
    ...
    // goto point system
    [[NSNotificationCenter defaultCenter] postNotificationName:@"addpoint" object:[NSNumber numberWithInt:selectedIndex+POINT_ADD_PREPARATION_1]];
}
